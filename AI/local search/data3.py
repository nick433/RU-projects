...
def main():
    ...
    b2 = 0
    c2 = 0
    while(n<5): #change back 5
        i = 0
        while(i<50):
            a = restartClimb(25, step25)
            b = restartClimb(10,step10)
            c = restartClimb(5, step5)
            a1 += a[1]
            a2 += a[2]
            b1 += b[1]
            b2 += b[2]
        ...
        csv += "25," + str(a1/50) + "," + str(step25) + "," + str(a2/50) + "\n" 
        csvb += "10," + str(b1/50) + "," + str(step10) + "," + str(b2/50) + "\n"
        csvc += "5," + str(c1/50) + "," + str(step5) + "," + str(c2/50) + "\n"
        step25 += 2
        step10 += 5
        step5 += 10
...
# 2000 iters, 1000 temp, .995 rate, try .999 next since after 55k iterations we are at 1e-120            
    ...
    data = "66,66"
    np.savetxt('Output.txt', ["5,%s" % data], fmt='%s')
