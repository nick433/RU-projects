...
/*
 * Node type. This is what makes up each part of a sorted list.
 * Each one has a data void* pointer and a next pointer to the next Node.
 * They also keep track of how many other things are pointing to them(iterators, head, next)
 */
struct _Node{
	void* data;
	struct _Node *next;
...
typedef struct _Node Node;/*may make_Node into _Node* and Node into NodePtr*/
...
struct SortedListIterator
{
	DestructFuncT dest;
	Node* curr;
	/*The getNextItem function will do most of the work*/ 
